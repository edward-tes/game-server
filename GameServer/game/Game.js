...
Game.prototype.startMatchingTimeout = function(timeout){
    console.log('start matching timeout');
 ...
 * Event Listener
 * */
Game.prototype.conDisconnected = function(playerCon){
    this.playerLeaveGame_(playerCon);
};
...
Game.prototype.clearMatchTimer_ = function(){
    if(this.matchingTimeoutID_){
        clearTimeout(this.matchingTimeoutID_);
        this.matchingTimeoutID_=0;
    }
};
