...
function QuizQuestionDao(db) {
    ...
    this.questionData_ = this.db_.get("tQuizQuestionEN");
    this.topicData_ = this.db_.get("tQuizTopicEN");
}

QuizQuestionDao.prototype.setLang = function(lang){
    this.questionData_ = this.db_.get("tQuizQuestion" + lang.toUpperCase());
    this.topicData_ = this.db_.get("tQuizTopic"+ lang.toUpperCase());
};
