...
GameLobby.prototype.createConnectionInstance_ = function (socket) {
    ...
    con.addEventListener(Connection.Event.DISCONNECTED, BOK.createDelegate(this, this.onConDisconnect_));
 ...
 * */
GameLobby.prototype.matchPublicGame_ = function (gameCon, gameReadyQueue, gameType) {
    ...
    console.log(this.openPublicGames_);
...
GameLobby.prototype.onConDisconnect_ = function (e) {

    var disConGame = (this.openPublicGames_[e.target.getTopic()] ? this.openPublicGames_[e.target.getTopic()][0] : null);
    console.log('connection disconnect' + disConGame);
    if (disConGame) {
        //TODO: remove created public game
        disConGame.conDisconnected(e.target);
        BOK.findAndRemove(this.openPublicGames_[e.target.getTopic()], disConGame);
    }
