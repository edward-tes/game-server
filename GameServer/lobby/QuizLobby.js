...
QuizLobby.prototype.setLang = function(lang){
    this.daoListObj_.questionDao.setLang(lang);
};
/**
 * @protected
 * @override
...
QuizLobby.prototype.onNewConnection_ = function (e) {
    var con = e.body;
    this.daoListObj_.questionDao.getAllTopics(1, 1, BOK.createDelegate(this, function (error, doc) {
        if (error) {
...
QuizLobby.prototype.onGetTopic_ = function(e){
    var con = e.target;
    var page = e.body;
    this.daoListObj_.questionDao.getAllTopics(1, page, BOK.createDelegate(this, function (error, doc) {
        if (error) {
            error.code = "get topic error";
        } else {
            this.daoListObj_.questionDao.getTopicsCount({}, function (err, count) {
